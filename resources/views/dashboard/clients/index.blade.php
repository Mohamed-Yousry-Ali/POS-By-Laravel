            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    @if(auth()->user()->hasPermission('orders_create'))
                        <a href="{{route('dashboard.clients.orders.create',$client->id)}}" class="btn btn-primary">@lang('site.add_order')</a></td>
                    @else
                    <a href="#" class="btn btn-primary disabled">@lang('site.add_order')</a></td>
                        @endif
                    <td>
